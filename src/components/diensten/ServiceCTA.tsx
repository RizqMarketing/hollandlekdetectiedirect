        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <h2 className="font-display text-4xl sm:text-5xl lg:text-6xl font-bold text-primary-foreground mb-6 leading-tight">
              Hulp nodig bij
              <br />
              <span className="text-primary-foreground/80">{serviceName}?</span>
            </h2>

            <p className="text-xl text-primary-foreground/70 mb-12 max-w-2xl mx-auto">
              Neem vandaag nog contact op voor een vrijblijvende inspectie.
              Onze specialisten staan 24/7 klaar om u te helpen.
            </p>
          </div>
