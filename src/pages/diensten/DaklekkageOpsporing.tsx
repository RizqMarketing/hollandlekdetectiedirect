...
const DaklekkageOpsporing = () => {
  const service = getServiceBySlug("daklekkage-opsporing")!;
    ...
    <div className="min-h-screen">
      ...
      <main>
        <ServiceHero
          ...
          stats={service.stats}
          image="/daklekkage.jpg"
          imageAlt="Professionele daklekkage opsporing door Holland Lekdetectie Direct"
        />
        <TrustSection />
...
export default DaklekkageOpsporing;
