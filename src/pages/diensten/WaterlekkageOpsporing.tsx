...
const WaterlekkageOpsporing = () => {
  const service = getServiceBySlug("waterlekkage-opsporing")!;
    ...
    <div className="min-h-screen">
      ...
      <main>
        <ServiceHero
          ...
          stats={service.stats}
          image="/waterlekkage.jpg"
          imageAlt="Waterlekkage opsporing met professionele apparatuur"
        />
        <TrustSection />
...
export default WaterlekkageOpsporing;
